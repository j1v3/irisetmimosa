<?php /* Smarty version Smarty-3.0.7, created on 2018-11-26 09:03:01
         compiled from "/var/www/irisetmimosa/themes/apparel/./product-list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:5800035065bfba8b5c12550-90477487%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5eb53a7428b17a77b9461f77345c9bac581db16f' => 
    array (
      0 => '/var/www/irisetmimosa/themes/apparel/./product-list.tpl',
      1 => 1543211303,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '5800035065bfba8b5c12550-90477487',
  'function' => 
  array (
  ),
...
?>
		<?php $_smarty_tpl->tpl_vars['brojcek'] = new Smarty_variable($_smarty_tpl->getVariable('broj')->value%3, null, null);?>
		<li class="ajax_block_product <?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['products']['first']){?>first_item<?php }elseif($_smarty_tpl->getVariable('smarty')->value['foreach']['products']['last']){?>last_item<?php }?> <?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['products']['index']%2){?>alternate_item<?php }else{ ?>item<?php }?> clearfix <?php if ($_smarty_tpl->getVariable('brojcek')->value==0){?>pfirst<?php }elseif($_smarty_tpl->getVariable('brojcek')->value==2){?>plast<?php }?>">
...
"><?php echo smarty_modifier_escape(smarty_modifier_truncate($_smarty_tpl->tpl_vars['product']->value['name'],20,'...'),'htmlall','UTF-8');?>
</a></h3>

			</div>																	 
			<div class="right_block">
				<?php if (isset($_smarty_tpl->tpl_vars['product']->value['on_sale'])&&$_smarty_tpl->tpl_vars['product']->value['on_sale']&&isset($_smarty_tpl->tpl_vars['product']->value['show_price'])&&$_smarty_tpl->tpl_vars['product']->value['show_price']&&!$_smarty_tpl->getVariable('PS_CATALOG_MODE')->value){?><span class="discount"><?php echo smartyTranslate(array('s'=>'Sale'),$_smarty_tpl);?>
</span>
				<?php }elseif(isset($_smarty_tpl->tpl_vars['product']->value['reduction'])&&$_smarty_tpl->tpl_vars['product']->value['reduction']&&isset($_smarty_tpl->tpl_vars['product']->value['show_price'])&&$_smarty_tpl->tpl_vars['product']->value['show_price']&&!$_smarty_tpl->getVariable('PS_CATALOG_MODE')->value){?><span class="discount"><?php echo smartyTranslate(array('s'=>'Sale'),$_smarty_tpl);?>
</span><?php }?>
