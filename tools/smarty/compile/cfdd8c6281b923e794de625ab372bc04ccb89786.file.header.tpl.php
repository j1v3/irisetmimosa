<?php /* Smarty version Smarty-3.0.7, created on 2018-11-26 06:49:57
         compiled from "/var/www/irisetmimosa/themes/apparel/header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1891849765bfb8985ba9868-33133393%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'cfdd8c6281b923e794de625ab372bc04ccb89786' => 
    array (
      0 => '/var/www/irisetmimosa/themes/apparel/header.tpl',
      1 => 1543211303,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1891849765bfb8985ba9868-33133393',
  'function' => 
  array (
  ),
...
ie8.css" rel="stylesheet" type="text/css" media="all" />
<![endif]-->

<!--[if IE 7]>
<link href="<?php echo $_smarty_tpl->getVariable('css_dir')->value;?>
ie7.css" rel="stylesheet" type="text/css" media="all" />
<![endif]-->
 ...
 <span class="bold"><?php echo $_smarty_tpl->getVariable('geolocation_country')->value;?>
		...
		<div id="page">
			...
			<div id="columns">
				...
				<!-- Center -->
				<div id="center_column" <?php if ($_smarty_tpl->getVariable('page_name')->value=='index'){?>class="full-wrap"<?php }else{ ?>class="page-wrap"<?php }?>>
	<?php }?>
