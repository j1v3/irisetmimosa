...
{else}
	...
	<ul class="block_various_links" id="block_various_links_footer">
		...
		{foreach from=$cmslinks item=cmslink}
			...
			{/if}
		{/foreach}
		{if $display_poweredby}<li class="last_item">{l s='Powered by' mod='blockcms'} <a href="http://www.prestashop.com">PrestaShop</a>&trade;</li>{/if} Theme by <a href="http://leadingthemes.com">Leading Themes</a>
	</ul>
	<!-- /MODULE Block footer -->
{/if}
