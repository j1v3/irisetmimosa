...
class blocktopmenu extends Module
{
  ...
  public function install()
  {
	...
	!$this->registerHook('header') ||  
       !Configuration::updateValue('MOD_BLOCKTOPMENU_ITEMS', 'CAT2,CAT3,CAT4') || 
  ...
  public function hooktop($param)
  {
	...
	function hookHeader() {
		Tools::addCSS(($this->_path).'css/dropdown.css', 'all');
		Tools::addCSS(($this->_path).'css/dropdown.vertical.rtl.css', 'all');
		Tools::addCSS(($this->_path).'css/default_theme.css', 'all');
	}
}
?>
